...
2. Read relevant code paths (grep/glob as needed) tied to requirements and critical flows.
...
6. Write the full report to `specs/active/[folder]/code-review.md` (same folder as spec.md/tasks.md) using the template below.

## Output
- Write the full Markdown report to `specs/active/[folder]/code-review.md` (same folder as spec.md/tasks.md).
- Return only the file path to the orchestrator.

Use this template for the file contents:
