...
description: TDD GREEN phase — Write minimal code to make failing tests pass. Used by the sdd-implement skill during TDD orchestration.
...
Search codebase for related code using Grep and Glob.
...
### Ready for: refactorer (REFACTOR phase)
```
